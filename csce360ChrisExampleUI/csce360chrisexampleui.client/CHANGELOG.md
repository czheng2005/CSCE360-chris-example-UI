...
- Create Angular project with ng: `ng new csce360chrisexampleui.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`csce360chrisexampleui.client.esproj`).
